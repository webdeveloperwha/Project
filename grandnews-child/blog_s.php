	    ...
	    <div class="post_content_wrapper">
	    	...
	    	<div class="post_header search">
				...
				?>
				    ...
				    <div class="post_img static one_third">
				        <a href="<?php the_permalink(); ?>">
				        	...
				        	<img <?php echo esc_html(grandnews_get_src_attr()); ?>="<?php echo esc_url($small_image_url[0]); ?>" alt="<?php echo esc_attr($image_alt); ?>" class=""/>
					    </a>
				    </div>
				...
				<div class="post_header_title <?php echo esc_attr($post_content_class); ?>">
				  	...
				  	<p><?php echo grandnews_get_excerpt_by_id(get_the_ID(),14); ?></p>
