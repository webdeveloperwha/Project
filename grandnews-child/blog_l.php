...
<div id="post-<?php the_ID(); ?>" <?php post_class($last_class); ?>>
					...
					?>
			      	...
			      	<div class="post_detail post_date">
			      		...
			      		<span class="post_info_date">
			      			<a href="<?php the_permalink(); ?>"><?php esc_html_e( 'Posted On', 'grandnews' ); ?> <?php echo date_i18n(THEMEDATEFORMAT, get_the_time('U')); ?></a>
			      		</span>
				  	</div>
			   </div>
