...
function grandnews_register_sidebars() 
{
	...
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'shop-sidebar', 'name' => 'Shop Sidebar', 'description' => 'The default sidebar for shop pages'));
        
        if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'header-sidebar', 'name' => 'Top Bar Configuration', 'description' => 'The default Banner for Header'));
...
add_action( 'widgets_init', 'grandnews_register_sidebars' );
